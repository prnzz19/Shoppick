...
<section id="shops" class="sp-wrap sp-section sp-shops-section sp-opportunities">
    <div class="sp-section-heading"><div><h2>Featured Shops</h2><p>View products from approved shops.</p></div></div><div class="sp-opportunity-grid">
    ...
    @endforelse
    <article id="community" class="sp-join-card sp-join-seller"><span class="sp-join-icon"><x-seller.icon name="store"/></span><h3>Have Something to Sell?</h3><p>Open your shop on SHOPPICK and start reaching more customers.</p><a class="sp-button sp-button-teal" href="{{ route('register.seller') }}">Start Selling <span aria-hidden="true">&rarr;</span></a></article>

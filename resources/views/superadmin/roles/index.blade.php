        ...
        <div class="card p-5">
            <div class="flex items-start justify-between">
                ...
                <div class="flex gap-1">
                    ...
                    <form method="POST" action="{{ route('superadmin.roles.destroy', $role->id) }}" data-confirm-title="Delete this role?" data-confirm-message="This action may permanently remove the selected role." data-confirm-action="Delete" data-confirm-type="danger">
                        @csrf @method('DELETE')

...
<div class="mb-6">
    ...
    <p class="text-sm text-slate-500">The single highest-authority SHOPPICK account</p>
</div>

<form method="GET" action="{{ route('admin.admins.index') }}" class="mb-5 flex gap-3">
        ...
        <table class="w-full min-w-[600px]">
            ...
            <tbody class="divide-y divide-slate-100">
                @forelse($admins as $admin)
                    <tr>
                        <td class="table-td">
                            <a href="{{ route('admin.users.show', $admin->id) }}" class="flex items-center gap-3">
                        ...
                        <td class="table-td text-right">
                            <a href="{{ route('admin.users.show', $admin->id) }}" class="btn-outline btn-sm">View</a>
                        </td>
                    </tr>
                @empty

...
<div class="mb-6 flex flex-wrap items-center justify-between gap-3">
    ...
    <div class="flex gap-2">
        @unless($user->hasRole('admin'))<a href="{{ route('admin.users.edit', $user->id) }}" class="btn-outline btn-sm">Edit</a>@endunless
        <a href="{{ route('admin.users.reset-password', $user->id) }}" class="btn-accent btn-sm">Reset Password</a>
    </div>
</div>

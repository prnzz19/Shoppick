...
<form method="POST" action="{{ route('admin.users.reset-password.store', $user->id) }}" class="card max-w-md p-6">
    @csrf
    <div class="space-y-4">
        <div>
    ...
    <div class="mt-6 flex gap-3">
        ...
        <a href="{{ route('admin.users.show', $user->id) }}" class="btn-ghost">Cancel</a>
    </div>
</form>
@endsection

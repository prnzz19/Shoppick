        ...
        <table class="w-full min-w-[700px]">
            ...
            <tbody class="divide-y divide-slate-100">
                @forelse($users as $user)
                    <tr>
                        <td class="table-td">
                            <a href="{{ route('admin.users.show', $user->id) }}" class="flex items-center gap-3">
                        ...
                        <td class="table-td">
                            <div class="flex justify-end gap-1">
                                ...
                                <form method="POST" action="{{ route('admin.users.destroy', $user->id) }}" data-confirm-title="Delete this user?" data-confirm-message="This action may permanently remove the selected user." data-confirm-action="Delete" data-confirm-type="danger">
                                    @csrf @method('DELETE')

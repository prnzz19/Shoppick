...
class RoleController extends Controller
{
    ...
    {
        $roles = Role::whereIn('slug', ['admin', 'seller', 'buyer', 'logistics', 'rider'])
            ->withCount('users', 'permissions')->with('permissions')->orderBy('name')->get();
    ...
    {
        if ($role->slug === 'admin') {
            return back()->with('error', 'The Admin role is the protected system authority.');
        }
    ...
    {
        if (in_array($role->slug, ['admin', 'buyer', 'seller', 'logistics', 'rider'])) {
